% include('header_si.tpl', title='Автоматическая проверка работ')
...
<h5>Щелкнув по тегу, вы можете добавить для него комментарий</h5>
    ...
    <div class="fixed_btns">
  	  <form style="display: inline-block;" action="/yandex/raw", method="POST" target="_blank">
...
<div class="row">
  <div class="col-sm-12">
    <form action='/yandex/reviews' method="POST">
