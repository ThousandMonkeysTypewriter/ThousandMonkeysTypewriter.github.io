...
function initCommonComment(code) {
  $.each(code.find('.com'), function(i, com){
    ...
    $(com).html('<span class="commentWrapper commonComment"><textarea style="background:#fff !important" readonly="readonly" rows="'+ rows +'" class="form-control">'+comText+'</textarea></span>');
